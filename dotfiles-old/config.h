...
static const char *amixer_lower[] = { "amixer", "set", "Master", "2dB-", NULL };
static const char *amixer_raise[] = { "amixer", "set", "Master", "2dB+", NULL };
...
static Key keys[] = {
    ...
    { 0,                            XF86XK_ScreenSaver, spawn, {.v = xscreensaver_lock } },
